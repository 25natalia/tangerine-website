...
export const en: Dictionary = {
  ...
  caseStudy: {
    ...
    process: { eyebrow: "The process", title: "How we got here" },
    research: { eyebrow: "The starting point", title: "What we found" },
    principles: { eyebrow: "Design Principles", title: "The principles that guided every decision" },
    visualIdentity: { eyebrow: "The solution", title: "The system" },
    gallery: { eyebrow: "In action", title: "The work, at real resolution" },
    bridge: { eyebrow: "From brand to experience" },
    ...
    learnings: { eyebrow: "Reflection", title: "What we learned" },
