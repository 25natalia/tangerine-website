...
export const es = {
	...
	caseStudy: {
		...
		challenge: { eyebrow: 'El reto' },
		objectives: { eyebrow: 'Objetivos', title: 'Lo que este proyecto tenía que lograr' },
		process: { eyebrow: 'El proceso', title: 'Cómo llegamos hasta acá' },
		research: { eyebrow: 'El punto de partida', title: 'Lo que encontramos' },
		principles: { eyebrow: 'Design Principles', title: 'Los principios que guiaron cada decisión' },
		visualIdentity: { eyebrow: 'La solución', title: 'El sistema' },
		gallery: { eyebrow: 'En acción', title: 'El trabajo, a resolución real' },
		bridge: { eyebrow: 'De la marca a la experiencia' },
		outcome: { eyebrow: 'Resultado' },
		mockups: {
		...
		learnings: { eyebrow: 'Reflexión', title: 'Qué aprendimos' },
