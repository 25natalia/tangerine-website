	...
	return (
		<section ref={sectionRef} className='relative overflow-hidden'>
			...
			>
             ...
             columna angosta. */}
					<FloatingElement
						className='absolute top-[8%] left-[4%] z-0 hidden w-8 xl:block'
						floatY={9}
						floatDuration={5.5}
						floatRotate={5}
						repelStrength={1}
					...
					<FloatingElement
						className='absolute bottom-[16%] left-0 z-0 hidden w-6 xl:block'
						floatY={11}
						floatDuration={4.5}
						floatRotate={-8}
						repelStrength={1.2}
					...
					<FloatingElement
						className='absolute top-[10%] right-0 z-0 hidden w-7 xl:block'
						floatY={10}
						floatDuration={5}
						floatRotate={7}
						repelStrength={1}
					...
					<FloatingElement
						className='absolute bottom-[10%] right-[6%] z-0 hidden w-6 xl:block'
						floatY={8}
						floatDuration={6}
						floatRotate={-6}
						repelStrength={1.1}
