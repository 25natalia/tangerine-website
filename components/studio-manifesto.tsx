      ...
      <Container size="content" className="py-20 sm:py-28">
        <div className="relative mx-auto max-w-2xl">
          ...
          <FloatingElement
            ...
            repelStrength={1.2}
          >
            <Image src="/illustrations/geometry/flor-orange.svg" alt="" width={153} height={160} className="h-auto w-full" />
          </FloatingElement>
          ...
          <FloatingElement
            ...
            repelStrength={1.3}
          >
            <Image src="/illustrations/geometry/semillas-violet.svg" alt="" width={174} height={174} className="h-auto w-full" />
          </FloatingElement>
